...
var EsquemaRespuestaEncuesta = new Schema({
    respuestasMateria: {
        type: [EsquemaRespuestaMateria]
    },
    encuesta: {
        type: EsquemaEncuesta
    },
...
export {
    RespuestaEncuesta, ModeloRespuestaEncuesta, EsquemaRespuestaEncuesta
};